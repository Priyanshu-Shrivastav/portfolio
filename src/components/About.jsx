      ...
      <div className="container max-w-[1200px] mx-auto md:p-[20px] md:mb-[50px]">
        ...
        <div className="flex flex-wrap p-5 columns-2 xl:flex xl:flex-nowrap gap-3">
          <div className="mb-[10px] mx-auto xl:basis-[40%]">
            <div className="shadow-lg hover:shadow-xl hover:cursor-pointer md:w-[400px] md:h-[400px] rounded-[30px] overflow-hidden border-[2px] border-[#A3A3A3]">
                <img
          ...
          <div className=" xl:basis-[60%]">
            <div className="columns-2 grid grid-col-1 md:flex md:flex-wrap xl:grid xl:grid-cols-2 my-8 gap-[20px] sm:gap-[35px]">
              <div className="shadow-lg hover:shadow-xl hover:cursor-pointer flex flex-col items-center sm:text-center flex-1 p-7 border-[2px] border-[#A3A3A3] rounded-[2rem] gap-2 mx-auto mb-[11px] sm:mb-0">
              ...
              <div className="shadow-lg hover:shadow-xl hover:cursor-pointer flex flex-col items-center flex-1 p-4 md:p-3 border-[2px] border-[#A3A3A3] rounded-[2rem] gap-2 text-center mx-auto">
            ...
            <div className="p-[12px] text-justify text-[#555555] mx-auto">
